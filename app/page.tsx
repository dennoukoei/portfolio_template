...
export default function Home() {
  return (
    <div className="overflow-hidden">
      {/* ヒーローセクション */}
      <section className="bg-gradient-to-br from-blue-100 via-white to-purple-100 py-20 sm:py-32">
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="lg:col-span-7">
              ...
              <div className="mt-10 flex items-center gap-x-6">
                <Link 
                  href="/projects"
                  className="rounded-md bg-blue-600 px-6 py-3 text-base font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition"
                >
                  プロジェクトを見る
                </Link>
                <Link 
                  href="/contact"
                  className="flex items-center text-base font-semibold text-gray-900 hover:text-blue-600 transition"
                >
            ...
            <div className="mt-12 lg:mt-0 lg:col-span-5 flex items-center justify-center">
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden p-8 w-64 h-64 sm:w-80 sm:h-80 flex items-center justify-center transform rotate-3 hover:rotate-0 transition duration-300">
                <div className="text-center">
                  <div className="text-6xl mb-4">👨‍💻</div>
                  <p className="text-lg font-medium text-gray-900">unknown</p>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">スキルと専門分野</h2>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {skills.map((skill, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center p-3 bg-blue-100 rounded-md text-blue-600">
                  {skill.icon}
                </div>
      ...
      <section className="py-16 sm:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">厳選プロジェクト</h2>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
